                    ...
                    <div class="card-body">
                        ...
                        <form action="assets/PHP/co_log.php" method="POST">
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="text" class="form-control" name="Pseudo" id="log_Pseudo" placeholder="Pseudo">
                            </div>
                            <!--  -->
                            <div class="input-group mb-2 mr-sm-2">
                                <div class="input-group-prepend">
                                ...
                                <input type="password" class="form-control" name="Pass" id="log_Pass" placeholder="Password">
                            </div>
                            <!--  -->
                            <div class="d-flex justify-content-end">
                                <button type="submit" class="btn btn-primary" name="login" id="login"><b>Connexion</b></button>
